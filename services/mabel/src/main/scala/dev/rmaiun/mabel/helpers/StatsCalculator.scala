...
import dev.rmaiun.mabel.dtos.stats.StatsState.{ loser, winner }
import dev.rmaiun.mabel.dtos.stats._
...
object StatsCalculator {
  ...
  private def winLossShortStats(
    ...
    SeasonShortStats(season, topPlayers, unrankedStats, rounds.size, daysToSeasonEnd, best, worst)
  }
